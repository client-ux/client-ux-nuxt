...
function initHeaderTitle() {
    const self = this;
    const $navbarHeader = $('.nk-header:not(.nk-header-left)');
    ...
    const $headerTitle = $('.nk-header-title > .nk-header-content');
    const $fullHeaderTitle = $('.nk-header-title-full > .nk-header-content');
